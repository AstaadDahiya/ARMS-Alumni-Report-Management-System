...
import { Briefcase, Calendar, Users, HeartHandshake, FileText, Edit, Newspaper, Shield } from "lucide-react";
    ...
    <div className="space-y-6">
        <div className="flex justify-between items-center">
            <div>
                ...
                <p className="text-muted-foreground">Welcome! Here's a snapshot of your network.</p>
            </div>
            <Button asChild>
            ...
            <Card>
                ...
                <CardContent className="space-y-3">
                    <Button variant="outline" className="w-full justify-start" asChild>
                        <Link href="/dashboard/update-requests"><FileText className="mr-2 h-4 w-4" /> View Update Requests</Link>
                    </Button>
                    <Button variant="outline" className="w-full justify-start" asChild>
                       <Link href="/dashboard/events"><Calendar className="mr-2 h-4 w-4" /> Manage Events</Link>
                    </Button>
                     <Button variant="outline" className="w-full justify-start" asChild>
                       <Link href="/dashboard/mentorship-requests"><HeartHandshake className="mr-2 h-4 w-4" /> Review Mentorships</Link>
                    </Button>
                </CardContent>
            </Card>
            <Card>
